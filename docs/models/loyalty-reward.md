...
Represents a contract to redeem loyalty points for a [reward tier](../models/loyalty-program-reward-tier.md) discount. Loyalty rewards can be in an ISSUED, REDEEMED, or DELETED state.
