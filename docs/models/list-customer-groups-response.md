...
a request to the [ListCustomerGroups](../api/customer-groups.md#list-customer-groups) endpoint.
...
| `groups` | [`CustomerGroup[] \| undefined`](../models/customer-group.md) | Optional | A list of customer groups belonging to the current seller. |
