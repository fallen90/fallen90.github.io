...
| `card` | [`Card`](../models/card.md) | Required | Represents the payment details of a card to be used for payments. These<br/>details are determined by the payment token generated by Web Payments SDK. |
