...
a request to the [RetrieveWebhookSubscription](../api/webhook-subscriptions.md#retrieve-webhook-subscription) endpoint.

Note: if there are errors processing the request, the [Subscription](../models/webhook-subscription.md) will not be
present.
