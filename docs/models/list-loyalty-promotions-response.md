...
Represents a [ListLoyaltyPromotions](../api/loyalty.md#list-loyalty-promotions) response.
...
| `loyaltyPromotions` | [`LoyaltyPromotion[] \| undefined`](../models/loyalty-promotion.md) | Optional | The retrieved loyalty promotions. |
