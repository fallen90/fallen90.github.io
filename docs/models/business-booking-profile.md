...
| `customerTimezoneChoice` | [`string \| undefined`](../models/business-booking-profile-customer-timezone-choice.md) | Optional | Choices of customer-facing time zone used for bookings. |
| `bookingPolicy` | [`string \| undefined`](../models/business-booking-profile-booking-policy.md) | Optional | Policies for accepting bookings. |
...
| `businessAppointmentSettings` | [`BusinessAppointmentSettings \| undefined`](../models/business-appointment-settings.md) | Optional | The service appointment settings, including where and how the service is provided. |
