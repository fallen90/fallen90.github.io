...
| `state` | [`string \| undefined`](../models/v1-order-state.md) | Optional | - |
...
| `subtotalMoney` | [`V1Money \| undefined`](../models/v1-money.md) | Optional | - |
| `totalShippingMoney` | [`V1Money \| undefined`](../models/v1-money.md) | Optional | - |
| `totalTaxMoney` | [`V1Money \| undefined`](../models/v1-money.md) | Optional | - |
| `totalPriceMoney` | [`V1Money \| undefined`](../models/v1-money.md) | Optional | - |
| `totalDiscountMoney` | [`V1Money \| undefined`](../models/v1-money.md) | Optional | - |
