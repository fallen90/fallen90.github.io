...
| `changes` | [`InventoryChange[] \| undefined`](../models/inventory-change.md) | Optional | The current calculated inventory changes for the requested objects<br/>and locations. |
