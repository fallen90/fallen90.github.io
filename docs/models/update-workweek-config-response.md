...
|  --- | --- | --- | --- |
| `workweekConfig` | [`WorkweekConfig \| undefined`](../models/workweek-config.md) | Optional | Sets the day of the week and hour of the day that a business starts a<br/>workweek. This is used to calculate overtime pay. |
