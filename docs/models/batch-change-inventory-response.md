...
| `counts` | [`InventoryCount[] \| undefined`](../models/inventory-count.md) | Optional | The current counts for all objects referenced in the request. |
| `changes` | [`InventoryChange[] \| undefined`](../models/inventory-change.md) | Optional | Changes created for the request. |
