...
| `scheduleType` | [`string \| undefined`](../models/fulfillment-pickup-details-schedule-type.md) | Optional | The schedule type of the pickup fulfillment. |
...
| `curbsidePickupDetails` | [`FulfillmentPickupDetailsCurbsidePickupDetails \| undefined`](../models/fulfillment-pickup-details-curbside-pickup-details.md) | Optional | Specific details for curbside pickup. |
