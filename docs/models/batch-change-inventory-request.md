...
| `changes` | [`InventoryChange[] \| null \| undefined`](../models/inventory-change.md) | Optional | The set of physical counts and inventory adjustments to be made.<br/>Changes are applied based on the client-supplied timestamp and may be sent<br/>out of order. |
