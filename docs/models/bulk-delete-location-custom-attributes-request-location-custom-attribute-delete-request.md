...
Represents an individual delete request in a [BulkDeleteLocationCustomAttributes](../api/location-custom-attributes.md#bulk-delete-location-custom-attributes)
