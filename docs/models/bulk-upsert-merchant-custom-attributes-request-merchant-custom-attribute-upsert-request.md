...
Represents an individual upsert request in a [BulkUpsertMerchantCustomAttributes](../api/merchant-custom-attributes.md#bulk-upsert-merchant-custom-attributes)
