...
| `rewards` | [`LoyaltyReward[] \| undefined`](../models/loyalty-reward.md) | Optional | The loyalty rewards that satisfy the search criteria.<br/>These are returned in descending order by `updated_at`. |
