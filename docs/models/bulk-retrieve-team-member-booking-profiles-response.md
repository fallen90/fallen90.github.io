...
Response payload for the [BulkRetrieveTeamMemberBookingProfiles](../api/bookings.md#bulk-retrieve-team-member-booking-profiles) endpoint.
...
|  --- | --- | --- | --- |
| `teamMemberBookingProfiles` | [`Record<string, RetrieveTeamMemberBookingProfileResponse> \| undefined`](../models/retrieve-team-member-booking-profile-response.md) | Optional | The returned team members' booking profiles, as a map with `team_member_id` as the key and [TeamMemberBookingProfile](entity:TeamMemberBookingProfile) the value. |
