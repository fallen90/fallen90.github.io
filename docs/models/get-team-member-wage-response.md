...
|  --- | --- | --- | --- |
| `teamMemberWage` | [`TeamMemberWage \| undefined`](../models/team-member-wage.md) | Optional | The hourly wage rate that a team member earns on a `Shift` for doing the job<br/>specified by the `title` property of this object. |
