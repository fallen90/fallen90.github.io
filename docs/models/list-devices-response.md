...
|  --- | --- | --- | --- |
| `errors` | [`Error[] \| undefined`](../models/error.md) | Optional | Information about errors that occurred during the request. |
| `devices` | [`Device[] \| undefined`](../models/device.md) | Optional | The requested list of `Device` objects. |
