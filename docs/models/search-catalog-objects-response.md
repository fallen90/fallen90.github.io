...
| `objects` | [`CatalogObject[] \| undefined`](../models/catalog-object.md) | Optional | The CatalogObjects returned. |
| `relatedObjects` | [`CatalogObject[] \| undefined`](../models/catalog-object.md) | Optional | A list of CatalogObjects referenced by the objects in the `objects` field. |
