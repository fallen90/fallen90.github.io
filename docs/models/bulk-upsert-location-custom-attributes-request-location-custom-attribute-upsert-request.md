...
Represents an individual upsert request in a [BulkUpsertLocationCustomAttributes](../api/location-custom-attributes.md#bulk-upsert-location-custom-attributes)
