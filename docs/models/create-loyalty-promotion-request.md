...
Represents a [CreateLoyaltyPromotion](../api/loyalty.md#create-loyalty-promotion) request.
...
|  --- | --- | --- | --- |
| `loyaltyPromotion` | [`LoyaltyPromotion`](../models/loyalty-promotion.md) | Required | Represents a promotion for a [loyalty program](../models/loyalty-program.md). Loyalty promotions enable buyers<br/>to earn extra points on top of those earned from the base program.<br/><br/>A loyalty program can have a maximum of 10 loyalty promotions with an `ACTIVE` or `SCHEDULED` status. |
