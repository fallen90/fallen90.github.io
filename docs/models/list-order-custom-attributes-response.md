...
|  --- | --- | --- | --- |
| `customAttributes` | [`CustomAttribute[] \| undefined`](../models/custom-attribute.md) | Optional | The retrieved custom attributes. If no custom attribute are found, Square returns an empty object (`{}`). |
