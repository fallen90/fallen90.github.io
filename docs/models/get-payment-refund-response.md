...
Defines the response returned by [GetRefund](../api/refunds.md#get-payment-refund).
...
| `refund` | [`PaymentRefund \| undefined`](../models/payment-refund.md) | Optional | Represents a refund of a payment made using Square. Contains information about<br/>the original payment and the amount of money refunded. |
