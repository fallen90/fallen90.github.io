...
Represents a response for an individual upsert request in a [BulkDeleteBookingCustomAttributes](../api/booking-custom-attributes.md#bulk-delete-booking-custom-attributes) operation.
