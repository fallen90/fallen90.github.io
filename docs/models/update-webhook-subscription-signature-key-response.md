...
a request to the [UpdateWebhookSubscriptionSignatureKey](../api/webhook-subscriptions.md#update-webhook-subscription-signature-key) endpoint.

Note: If there are errors processing the request, the [Subscription](../models/webhook-subscription.md) is not
present.
