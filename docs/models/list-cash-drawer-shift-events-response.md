...
| `cashDrawerShiftEvents` | [`CashDrawerShiftEvent[] \| undefined`](../models/cash-drawer-shift-event.md) | Optional | All of the events (payments, refunds, etc.) for a cash drawer during<br/>the shift. |
