...
Defines the response returned by [ListPaymentRefunds](../api/refunds.md#list-payment-refunds).
...
| `refunds` | [`PaymentRefund[] \| undefined`](../models/payment-refund.md) | Optional | The list of requested refunds. |
