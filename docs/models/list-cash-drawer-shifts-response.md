...
| `cashDrawerShifts` | [`CashDrawerShiftSummary[] \| undefined`](../models/cash-drawer-shift-summary.md) | Optional | A collection of CashDrawerShiftSummary objects for shifts that match<br/>the query. |
