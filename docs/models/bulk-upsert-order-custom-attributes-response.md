...
| `values` | [`Record<string, UpsertOrderCustomAttributeResponse>`](../models/upsert-order-custom-attribute-response.md) | Required | A map of responses that correspond to individual upsert operations for custom attributes. |
