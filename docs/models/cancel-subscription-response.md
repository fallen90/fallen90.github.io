...
[CancelSubscription](../api/subscriptions.md#cancel-subscription) endpoint.
...
| `actions` | [`SubscriptionAction[] \| undefined`](../models/subscription-action.md) | Optional | A list of a single `CANCEL` action scheduled for the subscription. |
