...
Represents an individual upsert request in a [BulkUpsertCustomerCustomAttributes](../api/customer-custom-attributes.md#bulk-upsert-customer-custom-attributes)
