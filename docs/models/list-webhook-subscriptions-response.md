...
a request to the [ListWebhookSubscriptions](../api/webhook-subscriptions.md#list-webhook-subscriptions) endpoint.
...
| `subscriptions` | [`WebhookSubscription[] \| undefined`](../models/webhook-subscription.md) | Optional | The requested list of [Subscription](entity:WebhookSubscription)s. |
