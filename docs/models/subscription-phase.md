...
| `cadence` | [`string`](../models/subscription-cadence.md) | Required | Determines the billing cadence of a [Subscription](../models/subscription.md) |
...
| `pricing` | [`SubscriptionPricing \| undefined`](../models/subscription-pricing.md) | Optional | Describes the pricing for the subscription. |
