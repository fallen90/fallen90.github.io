...
| `objects` | [`CatalogObject[] \| undefined`](../models/catalog-object.md) | Optional | A list of [CatalogObject](entity:CatalogObject)s returned. |
| `relatedObjects` | [`CatalogObject[] \| undefined`](../models/catalog-object.md) | Optional | A list of [CatalogObject](entity:CatalogObject)s referenced by the object in the `objects` field. |
