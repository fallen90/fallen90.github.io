...
|  --- | --- | --- | --- |
| `checkout` | [`Checkout \| undefined`](../models/checkout.md) | Optional | Square Checkout lets merchants accept online payments for supported<br/>payment types using a checkout workflow hosted on squareup.com. |
