...
| `limits` | [`CatalogInfoResponseLimits \| undefined`](../models/catalog-info-response-limits.md) | Optional | - |
| `standardUnitDescriptionGroup` | [`StandardUnitDescriptionGroup \| undefined`](../models/standard-unit-description-group.md) | Optional | Group of standard measurement units. |
