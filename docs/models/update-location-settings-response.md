...
|  --- | --- | --- | --- |
| `errors` | [`Error[] \| undefined`](../models/error.md) | Optional | Any errors that occurred when updating the location settings. |
| `locationSettings` | [`CheckoutLocationSettings \| undefined`](../models/checkout-location-settings.md) | Optional | - |
