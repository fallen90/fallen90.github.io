...
| `tenders` | [`Tender[] \| null \| undefined`](../models/tender.md) | Optional | The tenders used to pay in the transaction. |
| `refunds` | [`Refund[] \| null \| undefined`](../models/refund.md) | Optional | Refunds that have been applied to any tender in the transaction. |
...
| `product` | [`string \| undefined`](../models/transaction-product.md) | Optional | Indicates the Square product used to process a transaction. |
