...
[SearchSubscriptions](../api/subscriptions.md#search-subscriptions) endpoint.
...
| `query` | [`SearchSubscriptionsQuery \| undefined`](../models/search-subscriptions-query.md) | Optional | Represents a query, consisting of specified query expressions, used to search for subscriptions. |
