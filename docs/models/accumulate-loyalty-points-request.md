...
Represents an [AccumulateLoyaltyPoints](../api/loyalty.md#accumulate-loyalty-points) request.
...
|  --- | --- | --- | --- |
| `accumulatePoints` | [`LoyaltyEventAccumulatePoints`](../models/loyalty-event-accumulate-points.md) | Required | Provides metadata when the event `type` is `ACCUMULATE_POINTS`. |
