...
Represents a response for an individual upsert request in a [BulkUpsertBookingCustomAttributes](../api/booking-custom-attributes.md#bulk-upsert-booking-custom-attributes) operation.
