...
* [Batch Delete Catalog Objects](../api/catalog.md#batch-delete-catalog-objects)
* [Batch Retrieve Catalog Objects](../api/catalog.md#batch-retrieve-catalog-objects)
* [Batch Upsert Catalog Objects](../api/catalog.md#batch-upsert-catalog-objects)
* [Create Catalog Image](../api/catalog.md#create-catalog-image)
* [Update Catalog Image](../api/catalog.md#update-catalog-image)
* [Catalog Info](../api/catalog.md#catalog-info)
* [List Catalog](../api/catalog.md#list-catalog)
* [Upsert Catalog Object](../api/catalog.md#upsert-catalog-object)
* [Delete Catalog Object](../api/catalog.md#delete-catalog-object)
* [Retrieve Catalog Object](../api/catalog.md#retrieve-catalog-object)
* [Search Catalog Objects](../api/catalog.md#search-catalog-objects)
* [Search Catalog Items](../api/catalog.md#search-catalog-items)
* [Update Item Modifier Lists](../api/catalog.md#update-item-modifier-lists)
* [Update Item Taxes](../api/catalog.md#update-item-taxes)
...
|  --- | --- | --- | --- |
| `body` | [`BatchDeleteCatalogObjectsRequest`](../models/batch-delete-catalog-objects-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`BatchDeleteCatalogObjectsResponse`](../models/batch-delete-catalog-objects-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`BatchRetrieveCatalogObjectsRequest`](../models/batch-retrieve-catalog-objects-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`BatchRetrieveCatalogObjectsResponse`](../models/batch-retrieve-catalog-objects-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`BatchUpsertCatalogObjectsRequest`](../models/batch-upsert-catalog-objects-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`BatchUpsertCatalogObjectsResponse`](../models/batch-upsert-catalog-objects-response.md)
...
Uploads an image file to be represented by a [CatalogImage](../models/catalog-image.md) object that can be linked to an existing
[CatalogObject](../models/catalog-object.md) instance. The resulting `CatalogImage` is unattached to any `CatalogObject` if the `object_id`
is not specified.
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `request` | [`CreateCatalogImageRequest \| undefined`](../models/create-catalog-image-request.md) | Form (JSON-Encoded), Optional | - |
| `imageFile` | `FileWrapper \| undefined` | Form, Optional | - |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`CreateCatalogImageResponse`](../models/create-catalog-image-response.md)
...
Uploads a new image file to replace the existing one in the specified [CatalogImage](../models/catalog-image.md) object.
...
| `request` | [`UpdateCatalogImageRequest \| undefined`](../models/update-catalog-image-request.md) | Form (JSON-Encoded), Optional | - |
| `imageFile` | `FileWrapper \| undefined` | Form, Optional | - |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`UpdateCatalogImageResponse`](../models/update-catalog-image-response.md)
...
[`CatalogInfoResponse`](../models/catalog-info-response.md)
...
Returns a list of all [CatalogObject](../models/catalog-object.md)s of the specified types in the catalog.

The `types` parameter is specified as a comma-separated list of the [CatalogObjectType](../models/catalog-object-type.md) values,
for example, "`ITEM`, `ITEM_VARIATION`, `MODIFIER`, `MODIFIER_LIST`, `CATEGORY`, `DISCOUNT`, `TAX`, `IMAGE`".

__Important:__ ListCatalog does not return deleted catalog items. To retrieve
deleted catalog items, use [SearchCatalogObjects](../api/catalog.md#search-catalog-objects)
...
| `catalogVersion` | `bigint \| undefined` | Query, Optional | The specific version of the catalog objects to be included in the response.<br/>This allows you to retrieve historical versions of objects. The specified version value is matched against<br/>the [CatalogObject](../models/catalog-object.md)s' `version` attribute.  If not included, results will be from the<br/>current version of the catalog. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`ListCatalogResponse`](../models/list-catalog-response.md)
...
Creates a new or updates the specified [CatalogObject](../models/catalog-object.md).
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`UpsertCatalogObjectRequest`](../models/upsert-catalog-object-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`UpsertCatalogObjectResponse`](../models/upsert-catalog-object-response.md)
...
[`DeleteCatalogObjectResponse`](../models/delete-catalog-object-response.md)
...
[`RetrieveCatalogObjectResponse`](../models/retrieve-catalog-object-response.md)
...
Searches for [CatalogObject](../models/catalog-object.md) of any type by matching supported search attribute values,
excluding custom attribute values on items or item variations, against one or more of the specified query filters.

This (`SearchCatalogObjects`) endpoint differs from the [SearchCatalogItems](../api/catalog.md#search-catalog-items)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`SearchCatalogObjectsRequest`](../models/search-catalog-objects-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`SearchCatalogObjectsResponse`](../models/search-catalog-objects-response.md)
...
This (`SearchCatalogItems`) endpoint differs from the [SearchCatalogObjects](../api/catalog.md#search-catalog-objects)
endpoint in the following aspects:
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`SearchCatalogItemsRequest`](../models/search-catalog-items-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`SearchCatalogItemsResponse`](../models/search-catalog-items-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`UpdateItemModifierListsRequest`](../models/update-item-modifier-lists-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`UpdateItemModifierListsResponse`](../models/update-item-modifier-lists-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`UpdateItemTaxesRequest`](../models/update-item-taxes-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`UpdateItemTaxesResponse`](../models/update-item-taxes-response.md)
