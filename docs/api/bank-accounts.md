...
* [List Bank Accounts](../api/bank-accounts.md#list-bank-accounts)
* [Get Bank Account by V1 Id](../api/bank-accounts.md#get-bank-account-by-v1-id)
* [Get Bank Account](../api/bank-accounts.md#get-bank-account)


# List Bank Accounts

Returns a list of [BankAccount](../models/bank-account.md) objects linked to a Square account.
...
[`ListBankAccountsResponse`](../models/list-bank-accounts-response.md)
...
Returns details of a [BankAccount](../models/bank-account.md) identified by V1 bank account ID.
...
[`GetBankAccountByV1IdResponse`](../models/get-bank-account-by-v1-id-response.md)
...
Returns details of a [BankAccount](../models/bank-account.md)
...
[`GetBankAccountResponse`](../models/get-bank-account-response.md)
