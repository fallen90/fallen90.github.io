...
* [List Break Types](../api/labor.md#list-break-types)
* [Create Break Type](../api/labor.md#create-break-type)
* [Delete Break Type](../api/labor.md#delete-break-type)
* [Get Break Type](../api/labor.md#get-break-type)
* [Update Break Type](../api/labor.md#update-break-type)
* [List Employee Wages](../api/labor.md#list-employee-wages)
* [Get Employee Wage](../api/labor.md#get-employee-wage)
* [Create Shift](../api/labor.md#create-shift)
* [Search Shifts](../api/labor.md#search-shifts)
* [Delete Shift](../api/labor.md#delete-shift)
* [Get Shift](../api/labor.md#get-shift)
* [Update Shift](../api/labor.md#update-shift)
* [List Team Member Wages](../api/labor.md#list-team-member-wages)
* [Get Team Member Wage](../api/labor.md#get-team-member-wage)
* [List Workweek Configs](../api/labor.md#list-workweek-configs)
* [Update Workweek Config](../api/labor.md#update-workweek-config)
...
[`ListBreakTypesResponse`](../models/list-break-types-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`CreateBreakTypeRequest`](../models/create-break-type-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`CreateBreakTypeResponse`](../models/create-break-type-response.md)
...
[`DeleteBreakTypeResponse`](../models/delete-break-type-response.md)
...
[`GetBreakTypeResponse`](../models/get-break-type-response.md)
...
| `body` | [`UpdateBreakTypeRequest`](../models/update-break-type-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`UpdateBreakTypeResponse`](../models/update-break-type-response.md)
...
[`ListEmployeeWagesResponse`](../models/list-employee-wages-response.md)
...
[`GetEmployeeWageResponse`](../models/get-employee-wage-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`CreateShiftRequest`](../models/create-shift-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`CreateShiftResponse`](../models/create-shift-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`SearchShiftsRequest`](../models/search-shifts-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`SearchShiftsResponse`](../models/search-shifts-response.md)
...
[`DeleteShiftResponse`](../models/delete-shift-response.md)
...
[`GetShiftResponse`](../models/get-shift-response.md)
...
| `body` | [`UpdateShiftRequest`](../models/update-shift-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`UpdateShiftResponse`](../models/update-shift-response.md)
...
[`ListTeamMemberWagesResponse`](../models/list-team-member-wages-response.md)
...
[`GetTeamMemberWageResponse`](../models/get-team-member-wage-response.md)
...
[`ListWorkweekConfigsResponse`](../models/list-workweek-configs-response.md)
...
| `body` | [`UpdateWorkweekConfigRequest`](../models/update-workweek-config-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`UpdateWorkweekConfigResponse`](../models/update-workweek-config-response.md)
