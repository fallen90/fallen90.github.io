...
* [List Customer Groups](../api/customer-groups.md#list-customer-groups)
* [Create Customer Group](../api/customer-groups.md#create-customer-group)
* [Delete Customer Group](../api/customer-groups.md#delete-customer-group)
* [Retrieve Customer Group](../api/customer-groups.md#retrieve-customer-group)
* [Update Customer Group](../api/customer-groups.md#update-customer-group)
...
[`ListCustomerGroupsResponse`](../models/list-customer-groups-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`CreateCustomerGroupRequest`](../models/create-customer-group-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`CreateCustomerGroupResponse`](../models/create-customer-group-response.md)
...
[`DeleteCustomerGroupResponse`](../models/delete-customer-group-response.md)
...
[`RetrieveCustomerGroupResponse`](../models/retrieve-customer-group-response.md)
...
| `body` | [`UpdateCustomerGroupRequest`](../models/update-customer-group-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`UpdateCustomerGroupResponse`](../models/update-customer-group-response.md)
