...
* [Create Checkout](../api/checkout.md#create-checkout)
* [Retrieve Location Settings](../api/checkout.md#retrieve-location-settings)
* [Update Location Settings](../api/checkout.md#update-location-settings)
* [Retrieve Merchant Settings](../api/checkout.md#retrieve-merchant-settings)
* [Update Merchant Settings](../api/checkout.md#update-merchant-settings)
* [List Payment Links](../api/checkout.md#list-payment-links)
* [Create Payment Link](../api/checkout.md#create-payment-link)
* [Delete Payment Link](../api/checkout.md#delete-payment-link)
* [Retrieve Payment Link](../api/checkout.md#retrieve-payment-link)
* [Update Payment Link](../api/checkout.md#update-payment-link)
...
| `body` | [`CreateCheckoutRequest`](../models/create-checkout-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`CreateCheckoutResponse`](../models/create-checkout-response.md)
...
[`RetrieveLocationSettingsResponse`](../models/retrieve-location-settings-response.md)
...
|  --- | --- | --- | --- |
| `locationId` | `string` | Template, Required | The ID of the location for which to retrieve settings. |
| `body` | [`UpdateLocationSettingsRequest`](../models/update-location-settings-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`UpdateLocationSettingsResponse`](../models/update-location-settings-response.md)
...
[`RetrieveMerchantSettingsResponse`](../models/retrieve-merchant-settings-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`UpdateMerchantSettingsRequest`](../models/update-merchant-settings-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`UpdateMerchantSettingsResponse`](../models/update-merchant-settings-response.md)
...
[`ListPaymentLinksResponse`](../models/list-payment-links-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`CreatePaymentLinkRequest`](../models/create-payment-link-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`CreatePaymentLinkResponse`](../models/create-payment-link-response.md)
...
[`DeletePaymentLinkResponse`](../models/delete-payment-link-response.md)
...
[`RetrievePaymentLinkResponse`](../models/retrieve-payment-link-response.md)
...
| `body` | [`UpdatePaymentLinkRequest`](../models/update-payment-link-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`UpdatePaymentLinkResponse`](../models/update-payment-link-response.md)
