...
* [Renew Token](../api/o-auth.md#renew-token)
* [Revoke Token](../api/o-auth.md#revoke-token)
* [Obtain Token](../api/o-auth.md#obtain-token)
* [Retrieve Token Status](../api/o-auth.md#retrieve-token-status)
...
| `body` | [`RenewTokenRequest`](../models/renew-token-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `authorization` | `string` | Header, Required | Client APPLICATION_SECRET |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`RenewTokenResponse`](../models/renew-token-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`RevokeTokenRequest`](../models/revoke-token-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `authorization` | `string` | Header, Required | Client APPLICATION_SECRET |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`RevokeTokenResponse`](../models/revoke-token-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`ObtainTokenRequest`](../models/obtain-token-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`ObtainTokenResponse`](../models/obtain-token-response.md)
...
[`RetrieveTokenStatusResponse`](../models/retrieve-token-status-response.md)
