...
* [List Webhook Event Types](../api/webhook-subscriptions.md#list-webhook-event-types)
* [List Webhook Subscriptions](../api/webhook-subscriptions.md#list-webhook-subscriptions)
* [Create Webhook Subscription](../api/webhook-subscriptions.md#create-webhook-subscription)
* [Delete Webhook Subscription](../api/webhook-subscriptions.md#delete-webhook-subscription)
* [Retrieve Webhook Subscription](../api/webhook-subscriptions.md#retrieve-webhook-subscription)
* [Update Webhook Subscription](../api/webhook-subscriptions.md#update-webhook-subscription)
* [Update Webhook Subscription Signature Key](../api/webhook-subscriptions.md#update-webhook-subscription-signature-key)
* [Test Webhook Subscription](../api/webhook-subscriptions.md#test-webhook-subscription)
...
[`ListWebhookEventTypesResponse`](../models/list-webhook-event-types-response.md)
...
| `sortOrder` | [`string \| undefined`](../models/sort-order.md) | Query, Optional | Sorts the returned list by when the [Subscription](entity:WebhookSubscription) was created with the specified order.<br/>This field defaults to ASC. |
...
[`ListWebhookSubscriptionsResponse`](../models/list-webhook-subscriptions-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`CreateWebhookSubscriptionRequest`](../models/create-webhook-subscription-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`CreateWebhookSubscriptionResponse`](../models/create-webhook-subscription-response.md)
...
[`DeleteWebhookSubscriptionResponse`](../models/delete-webhook-subscription-response.md)
...
[`RetrieveWebhookSubscriptionResponse`](../models/retrieve-webhook-subscription-response.md)
...
| `body` | [`UpdateWebhookSubscriptionRequest`](../models/update-webhook-subscription-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`UpdateWebhookSubscriptionResponse`](../models/update-webhook-subscription-response.md)
...
|  --- | --- | --- | --- |
| `subscriptionId` | `string` | Template, Required | [REQUIRED] The ID of the [Subscription](entity:WebhookSubscription) to update. |
| `body` | [`UpdateWebhookSubscriptionSignatureKeyRequest`](../models/update-webhook-subscription-signature-key-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`UpdateWebhookSubscriptionSignatureKeyResponse`](../models/update-webhook-subscription-signature-key-response.md)
...
| `body` | [`TestWebhookSubscriptionRequest`](../models/test-webhook-subscription-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`TestWebhookSubscriptionResponse`](../models/test-webhook-subscription-response.md)
