...
* [List Payments](../api/payments.md#list-payments)
* [Create Payment](../api/payments.md#create-payment)
* [Cancel Payment by Idempotency Key](../api/payments.md#cancel-payment-by-idempotency-key)
* [Get Payment](../api/payments.md#get-payment)
* [Update Payment](../api/payments.md#update-payment)
* [Cancel Payment](../api/payments.md#cancel-payment)
* [Complete Payment](../api/payments.md#complete-payment)
...
[`ListPaymentsResponse`](../models/list-payments-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`CreatePaymentRequest`](../models/create-payment-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`CreatePaymentResponse`](../models/create-payment-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`CancelPaymentByIdempotencyKeyRequest`](../models/cancel-payment-by-idempotency-key-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`CancelPaymentByIdempotencyKeyResponse`](../models/cancel-payment-by-idempotency-key-response.md)
...
[`GetPaymentResponse`](../models/get-payment-response.md)
...
| `body` | [`UpdatePaymentRequest`](../models/update-payment-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`UpdatePaymentResponse`](../models/update-payment-response.md)
...
[`CancelPaymentResponse`](../models/cancel-payment-response.md)
...
| `body` | [`CompletePaymentRequest`](../models/complete-payment-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`CompletePaymentResponse`](../models/complete-payment-response.md)
