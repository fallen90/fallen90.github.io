...
* [List Bookings](../api/bookings.md#list-bookings)
* [Create Booking](../api/bookings.md#create-booking)
* [Search Availability](../api/bookings.md#search-availability)
* [Bulk Retrieve Bookings](../api/bookings.md#bulk-retrieve-bookings)
* [Retrieve Business Booking Profile](../api/bookings.md#retrieve-business-booking-profile)
* [List Location Booking Profiles](../api/bookings.md#list-location-booking-profiles)
* [Retrieve Location Booking Profile](../api/bookings.md#retrieve-location-booking-profile)
* [List Team Member Booking Profiles](../api/bookings.md#list-team-member-booking-profiles)
* [Bulk Retrieve Team Member Booking Profiles](../api/bookings.md#bulk-retrieve-team-member-booking-profiles)
* [Retrieve Team Member Booking Profile](../api/bookings.md#retrieve-team-member-booking-profile)
* [Retrieve Booking](../api/bookings.md#retrieve-booking)
* [Update Booking](../api/bookings.md#update-booking)
* [Cancel Booking](../api/bookings.md#cancel-booking)
...
[`ListBookingsResponse`](../models/list-bookings-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`CreateBookingRequest`](../models/create-booking-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`CreateBookingResponse`](../models/create-booking-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`SearchAvailabilityRequest`](../models/search-availability-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`SearchAvailabilityResponse`](../models/search-availability-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`BulkRetrieveBookingsRequest`](../models/bulk-retrieve-bookings-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`BulkRetrieveBookingsResponse`](../models/bulk-retrieve-bookings-response.md)
...
[`RetrieveBusinessBookingProfileResponse`](../models/retrieve-business-booking-profile-response.md)
...
[`ListLocationBookingProfilesResponse`](../models/list-location-booking-profiles-response.md)
...
[`RetrieveLocationBookingProfileResponse`](../models/retrieve-location-booking-profile-response.md)
...
[`ListTeamMemberBookingProfilesResponse`](../models/list-team-member-booking-profiles-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`BulkRetrieveTeamMemberBookingProfilesRequest`](../models/bulk-retrieve-team-member-booking-profiles-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`BulkRetrieveTeamMemberBookingProfilesResponse`](../models/bulk-retrieve-team-member-booking-profiles-response.md)
...
[`RetrieveTeamMemberBookingProfileResponse`](../models/retrieve-team-member-booking-profile-response.md)
...
[`RetrieveBookingResponse`](../models/retrieve-booking-response.md)
...
| `body` | [`UpdateBookingRequest`](../models/update-booking-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`UpdateBookingResponse`](../models/update-booking-response.md)
...
| `body` | [`CancelBookingRequest`](../models/cancel-booking-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`CancelBookingResponse`](../models/cancel-booking-response.md)
