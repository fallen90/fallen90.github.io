...
* [Create Loyalty Account](../api/loyalty.md#create-loyalty-account)
* [Search Loyalty Accounts](../api/loyalty.md#search-loyalty-accounts)
* [Retrieve Loyalty Account](../api/loyalty.md#retrieve-loyalty-account)
* [Accumulate Loyalty Points](../api/loyalty.md#accumulate-loyalty-points)
* [Adjust Loyalty Points](../api/loyalty.md#adjust-loyalty-points)
* [Search Loyalty Events](../api/loyalty.md#search-loyalty-events)
* [List Loyalty Programs](../api/loyalty.md#list-loyalty-programs)
* [Retrieve Loyalty Program](../api/loyalty.md#retrieve-loyalty-program)
* [Calculate Loyalty Points](../api/loyalty.md#calculate-loyalty-points)
* [List Loyalty Promotions](../api/loyalty.md#list-loyalty-promotions)
* [Create Loyalty Promotion](../api/loyalty.md#create-loyalty-promotion)
* [Retrieve Loyalty Promotion](../api/loyalty.md#retrieve-loyalty-promotion)
* [Cancel Loyalty Promotion](../api/loyalty.md#cancel-loyalty-promotion)
* [Create Loyalty Reward](../api/loyalty.md#create-loyalty-reward)
* [Search Loyalty Rewards](../api/loyalty.md#search-loyalty-rewards)
* [Delete Loyalty Reward](../api/loyalty.md#delete-loyalty-reward)
* [Retrieve Loyalty Reward](../api/loyalty.md#retrieve-loyalty-reward)
* [Redeem Loyalty Reward](../api/loyalty.md#redeem-loyalty-reward)
...
|  --- | --- | --- | --- |
| `body` | [`CreateLoyaltyAccountRequest`](../models/create-loyalty-account-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`CreateLoyaltyAccountResponse`](../models/create-loyalty-account-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`SearchLoyaltyAccountsRequest`](../models/search-loyalty-accounts-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`SearchLoyaltyAccountsResponse`](../models/search-loyalty-accounts-response.md)
...
[`RetrieveLoyaltyAccountResponse`](../models/retrieve-loyalty-account-response.md)
...
Adds points earned from a purchase to a [loyalty account](../models/loyalty-account.md).

- If you are using the Orders API to manage orders, provide the `order_id`. Square reads the order
  to compute the points earned from both the base loyalty program and an associated
  [loyalty promotion](../models/loyalty-promotion.md). For purchases that qualify for multiple accrual
...
- If you are not using the Orders API to manage orders, provide `points` with the number of points to add.
  ...
  loyalty promotion. For spend-based and visit-based programs, you can call [CalculateLoyaltyPoints](../api/loyalty.md#calculate-loyalty-points)
...
| `body` | [`AccumulateLoyaltyPointsRequest`](../models/accumulate-loyalty-points-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`AccumulateLoyaltyPointsResponse`](../models/accumulate-loyalty-points-response.md)
...
[AccumulateLoyaltyPoints](../api/loyalty.md#accumulate-loyalty-points)
...
|  --- | --- | --- | --- |
| `accountId` | `string` | Template, Required | The ID of the target [loyalty account](entity:LoyaltyAccount). |
| `body` | [`AdjustLoyaltyPointsRequest`](../models/adjust-loyalty-points-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`AdjustLoyaltyPointsResponse`](../models/adjust-loyalty-points-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`SearchLoyaltyEventsRequest`](../models/search-loyalty-events-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`SearchLoyaltyEventsResponse`](../models/search-loyalty-events-response.md)
...
[`ListLoyaltyProgramsResponse`](../models/list-loyalty-programs-response.md)
...
[`RetrieveLoyaltyProgramResponse`](../models/retrieve-loyalty-program-response.md)
...
- If you are using the Orders API to manage orders, provide the `order_id` and (optional) `loyalty_account_id`.
  ...
  [loyalty promotion](../models/loyalty-promotion.md).
...
- If you are not using the Orders API to manage orders, provide `transaction_amount_money` with the
  ...
  [ListLoyaltyPromotions](../api/loyalty.md#list-loyalty-promotions) and perform a client-side computation
...
| `body` | [`CalculateLoyaltyPointsRequest`](../models/calculate-loyalty-points-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`CalculateLoyaltyPointsResponse`](../models/calculate-loyalty-points-response.md)
...
Lists the loyalty promotions associated with a [loyalty program](../models/loyalty-program.md).
...
| `status` | [`string \| undefined`](../models/loyalty-promotion-status.md) | Query, Optional | The status to filter the results by. If a status is provided, only loyalty promotions<br/>with the specified status are returned. Otherwise, all loyalty promotions associated with<br/>the loyalty program are returned. |
...
[`ListLoyaltyPromotionsResponse`](../models/list-loyalty-promotions-response.md)
...
Creates a loyalty promotion for a [loyalty program](../models/loyalty-program.md). A loyalty promotion
...
| `body` | [`CreateLoyaltyPromotionRequest`](../models/create-loyalty-promotion-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`CreateLoyaltyPromotionResponse`](../models/create-loyalty-promotion-response.md)
...
[`RetrieveLoyaltyPromotionResponse`](../models/retrieve-loyalty-promotion-response.md)
...
[`CancelLoyaltyPromotionResponse`](../models/cancel-loyalty-promotion-response.md)
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`CreateLoyaltyRewardRequest`](../models/create-loyalty-reward-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`CreateLoyaltyRewardResponse`](../models/create-loyalty-reward-response.md)
...
[RetrieveLoyaltyReward](../api/loyalty.md#retrieve-loyalty-reward) endpoint.
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`SearchLoyaltyRewardsRequest`](../models/search-loyalty-rewards-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`SearchLoyaltyRewardsResponse`](../models/search-loyalty-rewards-response.md)
...
- If an order ID was specified when the reward was created
  (see [CreateLoyaltyReward](../api/loyalty.md#create-loyalty-reward)),
...
[`DeleteLoyaltyRewardResponse`](../models/delete-loyalty-reward-response.md)
...
[`RetrieveLoyaltyRewardResponse`](../models/retrieve-loyalty-reward-response.md)
...
| `body` | [`RedeemLoyaltyRewardRequest`](../models/redeem-loyalty-reward-request.md) | Body, Required | An object containing the fields to POST for the request.<br/><br/>See the corresponding object definition for field details. |
| `requestOptions` | `RequestOptions \| undefined` | Optional | Pass additional request options. |

## Response Type

[`RedeemLoyaltyRewardResponse`](../models/redeem-loyalty-reward-response.md)
